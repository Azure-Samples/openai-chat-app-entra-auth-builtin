...
2. Request access to Azure OpenAI Service by completing the form at [https://aka.ms/oai/access](https://aka.ms/oai/access) and awaiting approval. Alternatively you can use the following azd command to reduce the amount of quota your application needs: azd env set AZURE_OPENAI_DEPLOYMENT_CAPACITY 8
